...
class BillingController {
  ...
  async index ({ request, response, pagination }) {
      try {
        ...
        const queryPage = `SELECT COMPANIES.NAME,BILLINGS.ID, 
        BILLINGS.CARDS, BILLINGS.DESCRIPTION, BILLINGS.VALUE, 
        BILLINGS.BILLING_LINK, BILLINGS.STATUS 
        ...
        ${filterQuery}
        GROUP BY BILLINGS.ID, BILLINGS.DESCRIPTION, COMPANIES.NAME, 
