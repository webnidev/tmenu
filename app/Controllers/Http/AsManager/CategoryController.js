...
class CategoryController {
  ...
  async index ({ request, response, params }) {
    const establishment = await Establishment.query().where('id', params.id).first()
  ...
  async show ({ params, request, response }) {
    const establishment = await Establishment.query().where('id', params.establishment_id).first()
    const category = await Category.query().where('id', params.category_id)
